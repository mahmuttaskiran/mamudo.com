...
var tBlogs = [
  Blog(
    title: LanguageSensitiveString.enTr("Opcon: Evelution of an application", "Opcon: Bir uygulamanın evrimi"),
    content: LanguageSensitiveString.enTr(null,
    ...
    link: "https://medium.com/@taskiranmahmut/opcon-bir-uygulaman%C4%B1n-evrimi-db9c0cabfb5e",
  ),
  Blog(
    title: LanguageSensitiveString.enTr(null, "Evernote — Android Job"),
    content: LanguageSensitiveString.enTr(null,
    ...
    link: "https://medium.com/@taskiranmahmut/evernote-android-job-7a6d4477edc3",
  ),
  Blog(
    title: LanguageSensitiveString.enTr(null, "JobScheduler"),
    content: LanguageSensitiveString.enTr(null,
    ...
    link: "https://medium.com/@taskiranmahmut/nedir-ne-de%C4%9Fildir-1cecf8c9db3c",
  ),
  Blog(
    title: LanguageSensitiveString.enTr(null, "Hello, World!"),
    content: LanguageSensitiveString.enTr(null,
