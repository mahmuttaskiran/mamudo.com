...
var tExperiences = [
  Experience(
    ...
    description: LanguageSensitiveString.en_tr(
      "Developing a mobile application (BlueOpeeration) for Argeloji. BlueOperation offers RTLS solutions that can actively monitor the location of assets to optimize searching time in a wide range of area facilities such as Airports.",
